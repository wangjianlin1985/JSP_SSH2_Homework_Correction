		       ...
		       text: "老师管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "DepartCharge/departCharge_add.jsp"
			    	   	},
			    		{
			    	   		text: "老师管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "DepartCharge/departCharge_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "学生管理",
		       ...
		       text: "班级作业管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "DepartTask/departTask_add.jsp"
			    	   	},
			    		{
			    	   		text: "班级作业管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "DepartTask/departTask_query_result.jsp"
			    	    }
			    	   ]
			}*/,{
		       text: "学生日志管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Journal/journal_add.jsp"
			    	   	},
			    		{
			    	   		text: "学生日志管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Journal/journal_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "学生作业管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "StudentTask/studentTask_add.jsp"
			    	   	},
			    		{
			    	   		text: "学生作业管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "StudentTask/studentTask_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "学生进度管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "EmpProgress/empProgress_add.jsp"
			    	   	},
			    		{
			    	   		text: "学生进度管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "EmpProgress/empProgress_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "新闻管理",

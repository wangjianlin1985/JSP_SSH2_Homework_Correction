...
<jsp:include page="check_charge_logstate.jsp"/>
...
<div data-options="region:'north',title:'header',split:true,noheader:true" style="height:60px;background-color:#01B1EA;">
	<div class="logo">基于ssh成绩批改系统后台管理</div>
	<div class="logout">您好，<%=session.getAttribute("charge")%> | <a href="logout.jsp">退出</a></div>
</div>   
...
<script type="text/javascript" src="js/admin_charge.js"></script>
</body>
</html>
